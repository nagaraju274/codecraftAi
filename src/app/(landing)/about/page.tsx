        ...
        <section className="text-center max-w-4xl mx-auto">
            ...
            {/* Student-led Origin */}
             <div className="mt-12">
                ...
                <p className="mt-3 text-lg text-muted-foreground">
                   Mine-Yours was born from a shared passion for technology and a desire to create something meaningful. As students, we saw an opportunity to not only build our own products but also to collaborate with clients and bring their visions to life. This hybrid model allows us to stay at the forefront of innovation while honing our professional skills.
                </p>
            </div>
