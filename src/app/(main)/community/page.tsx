...
import { Search, MessageSquare, Eye, ThumbsUp } from "lucide-react";
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm">
                <li><Button variant="ghost" className="w-full justify-start">All Posts</Button></li>
                <li><Button variant="ghost" className="w-full justify-start">General Discussion</Button></li>
                <li><Button variant="ghost" className="w-full justify-start">Projects</Button></li>
                <li><Button variant="ghost" className="w-full justify-start">React</Button></li>
                <li><Button variant="ghost" className="w-full justify-start">Python</Button></li>
                 <li><Button variant="ghost" className="w-full justify-start">Playground</Button></li>
              </ul>
            </CardContent>
          </Card>
        </aside>
